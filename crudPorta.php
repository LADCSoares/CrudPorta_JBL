  ...
  <div class="navbar-fixed">
    ...
    <main class="container">
      ...
      <table class="bordered highlight responsive-table font1">
        ...
        <tbody>
          ...
          $sql = "SELECT id,cor,modelo,valor FROM porta";
    ...
    <div id="modal1" class="modal">
      <div class="modal-content">
        <h4>Excluir porta</h4>
        <p>Tem certeza que deseja excluir essa porta?</p>
      </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        if (isset($_GET['result'])) {
          if ($_GET['result'] == true) {
            echo "M.toast({html: 'Porta salva com sucesso!'})";
          } else {
            echo "M.toast({html: 'Erro ao salvar a porta!'})";
          }
        } ?>
      });
      ...
      function preencheId(id) {
        ...
        btnSim.href = "deletarPorta.php?id=" + id;
      }
    </script>
